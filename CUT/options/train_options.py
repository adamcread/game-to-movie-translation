...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--L1_mask', action="store_true", help='introduce L1 cycle loss on the extracted mask')
        parser.add_argument('--NCE_mask', action="store_true", help='introduce NCE patchwise boosted loss on the extracted mask')
