...
class AttentionGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        'i6_b', 'i7_b', 'i8_b', 'i9_b', 'i10_b', 'mask_A']
        ...
        'i6_a', 'i7_a', 'i8_a', 'i9_a', 'i10_a', 'mask_B']
    ...
    def backward_G(self):
        ...
        self.loss_A_mask = self.criterionBCE(self.a10_a, self.maskA)
        self.loss_B_mask = self.criterionBCE(self.a10_b, self.maskB)
        ...
        # combined loss and calculate gradients
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_cycle_A + self.loss_cycle_B + self.loss_idt_A + self.loss_idt_B + 0.1*(self.loss_A_mask + self.loss_B_mask)
